...
```
1.) Transfer 50 µl of yellow food colouring working solution from dye_reservoir A1 to destination_plate A1 with no mix cycles. [Tip action: eject tip]
2.) Transfer 50 µl of yellow food colouring working solution from dye_reservoir A1 to destination_plate A2 with no mix cycles. [Tip action: eject tip]
3.) Transfer 50 µl of yellow food colouring working solution from dye_reservoir A1 to destination_plate A3 with no mix cycles. [Tip action: eject tip]
4.) Transfer 50 µl of yellow food colouring working solution from dye_reservoir A1 to destination_plate B1 with no mix cycles. [Tip action: eject tip]
5.) Transfer 50 µl of yellow food colouring working solution from dye_reservoir A1 to destination_plate B2 with no mix cycles. [Tip action: eject tip]
6.) Transfer 50 µl of yellow food colouring working solution from dye_reservoir A1 to destination_plate B3 with no mix cycles. [Tip action: eject tip]
7.) Transfer 50 µl of yellow food colouring working solution from dye_reservoir A1 to destination_plate C1 with no mix cycles. [Tip action: eject tip]
8.) Transfer 50 µl of yellow food colouring working solution from dye_reservoir A1 to destination_plate C2 with no mix cycles. [Tip action: eject tip]
9.) Transfer 50 µl of yellow food colouring working solution from dye_reservoir A1 to destination_plate C3 with no mix cycles. [Tip action: eject tip]
```
