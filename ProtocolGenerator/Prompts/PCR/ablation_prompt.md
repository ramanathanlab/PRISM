...
- Can only transfer plate at a time
...
- `ot2bioalpha_deck3_wide` - OT-2 robot deck position 3 (wide)
...
- Can hold one plate at a time in each deck location
...
7.) Mix 10X with pipette set to 20 uL in wells B2, G2, B11, and G11 of dest_plate.
8.) Seal the dest_plate to prepare it for thermocycling
9.) Perform a thermocycling operation (program #5) on dest_plate
10.) Peel the dest_plate to prepare it for reading
11.) Perform an absorbance reading using the Hidex plate reader (protocol "PCR_Final_Results") on dest_plate
12.) Leave the dest_plate in the Hidex plate reader
13.) Seal the react_plate to prepare it for thermocycling
14.) Perform a thermocycling operation (program #5) on react_plate
15.) Peel the react_plate to prepare it for reading
16.) Perform an absorbance reading using the Hidex plate reader (protocol "PCR_Final_Results") on react_plate
